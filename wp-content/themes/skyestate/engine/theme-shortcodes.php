    ...
    function nvr_people($atts, $content = null) {
        ...
        if( have_posts() ){
            ...
            while ( have_posts() ) : the_post();
                ...
                $nvr_output .= '<div class="clearfix"></div>';
                $nvr_output .= '<div class="leader_mail">';
                if($peoplemail){
                    $nvr_output .= '<a href="mailto:'.esc_attr( $peoplemail ).'" target="_blank" title="'.esc_attr( $peoplemail ).'" class="nvrtooltip"><span><i class="fa fa-envelope"></i>'.esc_attr( $peoplemail ).'</span></a>';
                }
                $nvr_output .= '<div class="clearfix"></div>';
                $nvr_output .= '</div>';
                $nvr_output .= '<div class="clearfix"></div>';
