...
$nvr_output  .='<div class="clearfix"></div>';
        ...
        $nvr_output  .='<div class="clear spacer">&nbsp;</div>';
...
//nick
if(!function_exists('nvr_prj_get_box_custome')){
	function nvr_prj_get_box_custome( $nvr_imgsize, $nvr_postid="",$nvr_class="", $nvr_unit = '', $nvr_cursymbol = '', $nvr_curplace = '',$content='' ){
		...
		$nvr_state = (isset($nvr_custom[$nvr_initial."_state"][0]))? $nvr_custom[$nvr_initial."_state"][0] : '';
		$nvr_country = (isset($nvr_custom[$nvr_initial."_country"][0]))? $nvr_custom[$nvr_initial."_country"][0] : '';
		$prop_categories = (isset($nvr_custom['prop_categories'][0]))? $nvr_custom['prop_categories'][0] : '';
...
//                exit();
		...
		$nvr_output  .='<li class="prop-item-container '.esc_attr( $nvr_class ).'" style="width:100%!important;">';
			$nvr_output  .='<div class="nvr-prop-box_custome">';
				$nvr_output  .='<div class="nvr-prop-img" >';
...
//					}
				...
				$nvr_output  .='</div>';
                                // get the terms related to post
				$nvr_output_meta = '';
				if ( !empty( $prop_categories ) ) {
//					$nvr_output_meta .= '<span class="nvr-prop-type"><i class="fa fa-building"></i>&nbsp; '. $nvr_type .'</span>';
					$nvr_output_meta .= '<span class="nvr-prop-type"><i class="fa fa-building"></i>&nbsp; '. $prop_categories .'</span>';
				}
				$nvr_output  .='<div class="nvr-prop-text">';
